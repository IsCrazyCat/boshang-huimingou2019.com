...
<div class="page" id='{$data.act}'>
    ...
    <?php if( $hide_footer != 1): ?><nav class="bar bar-tab">
            <a class="tab-item  " href="#" onclick="RouterURLWAP('/wap/index','',1)">
            <i class="icon iconfont">&#xe63f;</i>
            <span class="tab-label">首页</span>
            </a>

            <a class="tab-item active" href="#" onclick="RouterURLWAP('/wap/Finance/chushiye/uId/<?php echo ($uId); ?>','',1)">
            <i class="icon iconfont">&#xe63b;</i>
       ...
       <div class="content pull-to-refresh-content">
        ...
        <header class="bar bar-nav">
            <h1 class='title'>数据区</h1>
        </header>
        <div class="content">
            <div class="content-block qius">
                <p style="padding-top: 6px"><a  class="button button-fill" onclick="RouterURLWAP('/wap/Finance/index/uId/<?php echo ($uId); ?>','',1)">我的资产</a></p>
                <p style="padding-top: 6px"><a href="#" class="button button-fill button-success" onclick="RouterURLWAP('/wap/Finance/withdrawals/uId/<?php echo ($uId); ?>','',1)">资产提现</a></p>
                <p style="padding-top: 6px"><a href="#" class="button button-fill button-danger" onclick="RouterURLWAP('/wap/Finance/moneylogs/uId/<?php echo ($uId); ?>','',1)">财务记录</a></p>
                <p style="padding-top: 6px"><a href="#" class="button button-fill button-warning" onclick="RouterURLWAP('/wap/RegCode/PaidanbiwCode/at/1','',1)">手续费购买转帐记录</a></p>
                <p style="padding-top: 6px"><a href="#" class="button button-fill button-danger" onclick="RouterURLWAP('/wap/RegCode/ReviewCode/at/1','',1)">激活码购买转帐记录</a></p>
                <p style="padding-top: 6px"><a href="#" class="button button-fill button-warning" onclick="RouterURLWAP('/wap/index/index','',1)">星级记录</a></p>
                <p style="padding-top: 6px"><a href="#" class="button button-fill button-success" onclick="RouterURLWAP('/wap/Finance/scjflogs/uId/<?php echo ($uId); ?>','',1)">商城积分记录</a></p>
                <p style="display: none">
                    <a href="#" class="button button-fill button-warning" onclick="RouterURLWAP('/wap/index/index','',1)">诚信金记录</a>
                </p>
            </div>
        </div>
