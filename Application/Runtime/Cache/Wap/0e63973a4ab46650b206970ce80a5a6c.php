...
<div class="page" id='{$data.act}'>
    ...
    <?php if( $hide_footer != 1): ?><nav class="bar bar-tab">
            ...
            <a class="tab-item active"  href="#" onclick="RouterURLWAP('/wap/Users/chushiye/uId/<?php echo ($uId); ?>','',1)">
            <i class="icon iconfont">&#xe640;</i>
    ...
    <div class="content pull-to-refresh-content">
        ...
        <div class="content">
            <div class="content-block">
                <p><a  class="button button-fill" onclick="RouterURLWAP('/wap/Users/updateuser/uId/<?php echo ($uId); ?>','',1)">修改资料</a></p>
                <p><a href="#" class="button button-fill button-success" onclick="RouterURLWAP('/wap/Users/updateuserloginpassword/uId/<?php echo ($uId); ?>','',1)">修改登录密码</a></p>
                <p><a href="#" class="button button-fill button-danger" onclick="RouterURLWAP('/wap/Users/updateusersafepassword/uId/<?php echo ($uId); ?>','',1)">修改安全密码</a></p>
                <p><a href="#" class="button button-fill button-warning" onclick="RouterURLWAP('/wap/Books/add','',1)">意见反馈</a></p>
                <p><a href="#" class="button button-fill button-danger" onclick="RouterURLWAP('/wap/Announcement/lists','',1)">公告</a></p>
                <p><a href="#" class="button button-fill button-warning" onclick="RouterURLWAP('/wap/Article/article','',1)">关于平台</a></p>
            </div>
        </div>
