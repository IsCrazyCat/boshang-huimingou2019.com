...
<div class="content">
    <div class="buttons-tab">
        ...
        <a href="/Wap/Assistance/SuiJiQu/uId/<?php echo ($uIdjs); ?>" class="active button">随机区</a>
...
<!--                                    <td><?php echo ($val_invest["uiId"]); ?></td>-->
                                    ...
                                    <script type='text/javascript' src='/Public/Default/wap/js/jquery-3.4.0.min.js' charset='utf-8'></script>
