            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>确认收款 <small></small></h5>
                        <div class="ibox-tools">
                            
                        </div>
                    </div>
                    <div class="ibox-content">
                        <form method="post" action="/Wap/Assistance/YesUnPayInvestAction/uuniId/<?php echo ($uuniId); ?>/uId/<?php echo ($rs_users["uId"]); ?>" class="form-horizontal" id="form-admin-add" enctype="multipart/form-data" >
                        <!--
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label">我的收款账户</label>
                                <div class="col-sm-10">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="hidden" class="form-control" name="zfsj" value="<?php echo ($zfsj); ?>">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label">对方付款账户（支付宝）</label>
                                <div class="col-sm-10">
                            ...
                            <div class="form-group" style="display: none">
                                ...
                                <!--
                                <div class="form-group">
                                <label class="col-sm-2 control-label">上传收款截图</label>
                                    <div class="col-sm-10">
                                        <input type="file" name="uuniImages" id="uuniImages" class="form-control">
                                    </div>
                                 </div>
                                 -->

                                <div class="form-group">
                                <label class="col-sm-2 control-label"><a class="upimgs" id="btn" style="background-color:#039dbe; width:100px;">上传收款截图</a></label>
                                    <div class="col-sm-10">
                                        <dl style="margin-bottom:5px;" id="ul_pics" class="ul_pics clearfix" ></dl>
                                        <input type="text" class="form-control upload-url" name="uuniImages" id="pPic" required>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                <div class="col-sm-4 col-sm-offset-2">
                                        <input class="btn btn-primary" type="submit">确认已经收款</button>
                                </div>
                            </div>
                            -->
                            <div class="form-group">
                                <div class="col-sm-8 col-sm-offset-2">
                                    <input class="btn btn-primary" type="submit" value="确认已经收款">
                                </div>
                            </div>
                        </form>
                    </div>
