            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form method="post" action="/Wap/Assistance/YesPayInvestAction/uiId/<?php echo ($uiId); ?>/uId/<?php echo ($rs_users["uId"]); ?>" class="form-horizontal" id="form-admin-add" enctype="multipart/form-data" >
