...
<link href="/Public/Default/404/css/style.css" type="text/css" rel="stylesheet">
...
<body>
	...
	<div class="container">
      <div class="container_1"><img src="/Public/Default/404/images/404.png"></div>
      <div class="container_2"><img src="/Public/Default/404/images/3.22.gif" ></div>
      <div class="container_3"><!--<img src="images/404_1.png" >-->
         <div class="container_3_1" style="font-size:16px;"><span>你要访问的页面不存在<a style="color:#F63" href="/index.php">返回主页</a></span></div>
         
      </div>
    </div>
    <!--<img src="/Public/Default/404/images/001_1.gif" width="1000px" height="600px">--></div>
    <!--导航-->
	<div class="maincolumn">
	  <div class="maincolumn_bg">
         <a id="href" href="/index.php"></a></span><span><a style="color:#ffffff" href="/index.php">请耐心等待 <b id="wait"> 6 </b> 秒,转到首页</a></span></p>
